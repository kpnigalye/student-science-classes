      ...
      <section className="py-14 px-4 bg-slate-50">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-14">
            ...
            {/* Science - Active */}
            <a href="#science-courses" className="block group">
          ...
          {/* Science Courses Detail */}
          <div id="science-courses" className="scroll-mt-24">
            <h3 className="text-2xl font-bold text-center mb-3 text-blue-900">Science Courses</h3>
            <p className="text-center text-gray-500 mb-10 max-w-lg mx-auto">XI – XII Science stream batches</p>
            ...
            {/* Entrance Exams under Science */}
            <div className="mt-14">
              <h3 className="text-2xl font-bold text-center mb-10 text-blue-900">Entrance Exams</h3>
